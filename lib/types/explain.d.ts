...
export declare function isUsableRoute(route: {
    provider?: unknown;
    model?: unknown;
} | undefined): route is ModelRoute;
/** Ids of every provider the llm service currently has registered. */
export declare function liveProviderIds(ctx: Context): string[];
...
export declare function resolveModelRoute(ctx: Context, lastRoute?: ModelRoute | undefined, override?: ModelRoute | undefined): ModelRoute;
